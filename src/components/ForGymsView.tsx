    ...
    <div className="w-full bg-white overflow-hidden">
      ...
      <section className="relative w-full pt-4 md:pt-6">
        <div className="relative max-w-[1440px] mx-auto min-h-[540px] flex items-center">
          ...
          <div className="absolute inset-y-0 right-0 w-full md:w-[56%] lg:w-[52%] z-0 hidden md:block overflow-hidden">
            ...
            <div 
              className="absolute inset-y-0 left-0 w-6 lg:w-7 bg-[#E92E3D] z-10 hidden md:block"
              style={{
            ...
            >
              ...
              >
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-2.5">
                    <div className="w-6 h-6 rounded-md bg-red-50 text-[#E92E3D] flex items-center justify-center shrink-0 border border-red-100/60">
              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2.5 pt-1 border-t border-gray-100/80">
                    <div className="w-6 h-6 rounded-md bg-red-50 text-[#E92E3D] flex items-center justify-center shrink-0 border border-red-100/60">
                      <Star className="w-3 h-3 fill-[#E92E3D]" />
                    </div>
                    <div className="flex items-baseline gap-1.5">
          ...
          <div className="relative z-10 w-full md:w-[54%] lg:w-[50%] flex flex-col justify-center px-6 md:pl-12 lg:pl-16 py-8 md:py-12">
            ...
            <div className="flex items-center gap-2 mb-3">
              <Dumbbell className="w-4 h-4 text-[#E92E3D] -rotate-45" />
              <p className="text-[12px] font-bold text-[#E92E3D] uppercase tracking-[0.16em]">
            ...
            <h1 className="text-[40px] md:text-[50px] lg:text-[56px] xl:text-[62px] font-extrabold tracking-tight text-gray-900 leading-[1.08] mb-4 max-w-[580px]">
              ...
              Build a <span className="text-[#E92E3D]">stronger gym.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-9">
              <Link href="/auth/gym-signup">
                <Button className="bg-[#E92E3D] hover:bg-[#d42936] active:scale-[0.97] transition-all duration-200 ease-out active:duration-0 text-white h-[46px] px-[26px] rounded-xl text-[15px] font-semibold shadow-[0_8px_20px_rgb(217,26,36,0.25)] w-full sm:w-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-4 gap-x-5 max-w-[680px]">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1.5">
                  <div className="w-7 h-7 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-100">
                    <ShieldCheck className="w-3.5 h-3.5 text-[#E92E3D]" />
                  </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1.5">
                  <div className="w-7 h-7 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-100">
                    <Target className="w-3.5 h-3.5 text-[#E92E3D]" />
                  </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1.5">
                  <div className="w-7 h-7 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-100">
                    <Clock className="w-3.5 h-3.5 text-[#E92E3D]" />
                  </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1.5">
                  <div className="w-7 h-7 rounded-full bg-red-50 flex items-center justify-center shrink-0 border border-red-100">
                    <Wallet className="w-3.5 h-3.5 text-[#E92E3D]" />
                  </div>
      ...
      <section className="max-w-[1360px] mx-auto px-6 pt-2 pb-8 md:pb-12">
        <div className="text-center mb-6 md:mb-8">
          <p className="text-xs font-bold text-[#E92E3D] uppercase tracking-[0.16em] mb-2">
            How It Works
          </p>
          <h2 className="text-2xl md:text-[28px] font-bold text-gray-900 tracking-tight">
            Hire in <span className="text-[#E92E3D]">4</span> simple steps
          </h2>
        </div>
              ...
              <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left group">
                <div className="relative mb-3">
                  <div className="w-[68px] h-[68px] rounded-full bg-red-50/60 border border-red-100 flex items-center justify-center group-hover:scale-105 transition-all duration-300">
                    <s.icon className="w-6 h-6 text-[#E92E3D]" />
                  </div>
                  <span className="absolute -top-0.5 -right-0.5 w-5 h-5 rounded-full bg-[#E92E3D] text-white text-[11px] font-bold flex items-center justify-center shadow-xs">
                    {s.step}
                  </span>
                </div>
                <h3 className="text-[16px] font-bold text-gray-900 mb-1 group-hover:text-[#E92E3D] transition-colors">
                  {s.title}
                </h3>
      ...
      <section className="max-w-[1360px] mx-auto px-6 pb-10 md:pb-12">
        <div className="bg-[#faf7f7] border border-red-100/70 rounded-[2rem] p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 flex items-start gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[#E92E3D] text-white flex items-center justify-center shadow-md shrink-0">
            ...
            <ul className="flex flex-col gap-2">
              {[
                ...
                <li key={i} className="flex items-center gap-2 text-xs md:text-[13px] text-gray-600">
                  <CheckCircle2 className="w-4 h-4 text-[#E92E3D] shrink-0" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="lg:col-span-4 flex flex-col items-center lg:items-end justify-center gap-3">
            ...
            <Button className="bg-[#E92E3D] hover:bg-[#d42936] active:scale-[0.97] transition-all duration-200 ease-out active:duration-0 text-white h-[44px] px-[22px] rounded-xl text-[14px] font-semibold shadow-md w-full sm:w-auto">
              Find a Trainer for Your Gym <ArrowRight className="w-4 h-4 ml-1.5" />
            </Button>
            <Link
              href="#how-it-works"
